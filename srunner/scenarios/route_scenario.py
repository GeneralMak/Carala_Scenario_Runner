...
from srunner.scenarios.follow_nosignaljuntioncrossing_vehicle import Follow_NoSignalJunctionCrossing_Vehicle
...
NUMBER_CLASS_TRANSLATION = {
    ...
    "Scenario11": Follow_NoSignalJunctionCrossing_Vehicle
}
...
class RouteScenario(BasicScenario):
    ...
    def _get_actors_instances(self, list_of_antagonist_actors):
        ...
        def get_actors_from_list(list_of_actor_def):
            """
                接收演员定义列表并创建一个 ActorConfigurationObjects 的实际列表
        ...
        list_of_actors = []
        # Parse vehicles to the left  解析车辆
    ...
    def _initialize_actors(self, config):
        """
        将 other_actors 设置为所有场景 actor 的超集
        Set other_actors to the superset of all scenario actors
        """

        # Create the background activity of the route  创建路由的后台活动
        town_amount = {
            'Town01': 120,
            'Town02': 100,
            'Town03': 120,
        ...
        # Add all the actors of the specific scenarios to self.other_actors 将特定场景的所有actor添加到self.other_actors
    ...
    def _create_behavior(self):
        ...
        """
        scenario_trigger_distance = 1.5  # Max trigger distance between route and scenario 路线与场景的最大触发距离
        ...
        # Add behavior that manages the scenarios trigger conditions 添加管理场景触发条件的行为
        ...
        subbehavior.add_child(Idle())  # The behaviours cannot make the route scenario stop  行为不能使路线场景停止
