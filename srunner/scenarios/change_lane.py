...
class ChangeLane(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._fast_vehicle_velocity = 70    #快车速度
        self._slow_vehicle_velocity = 0     #慢车速度
        self._change_lane_velocity = 15     #快车换道时的速度
    ...
    def _create_behavior(self):
        ...
        Idle:该类为一个空闲行为场景：
            重要参数：
                duration[optional]:此行为的持续时间
        '''
        # brake, avoid rolling backwarts  刹车，避免倒车
